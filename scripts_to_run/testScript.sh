...
sed -i "/TYPE=/ c TYPE=300M" /home/zc/bryantchang/SparkBench/SVDPlusPlus/conf/env.sh
...
sed -i "/TYPE=/ c TYPE=300M" /home/zc/bryantchang/SparkBench/PageRank/conf/env.sh
