...
sed -i "/SPARK_EXECUTOR_MEMORY=/ c SPARK_EXECUTOR_MEMORY=1600m" /home/hadoop/bryantchang/codes/SparkBench/SVDPlusPlus/conf/env.sh
...
sed -i "/SPARK_EXECUTOR_MEMORY=/ c SPARK_EXECUTOR_MEMORY=1700m" /home/hadoop/bryantchang/codes/SparkBench/PageRank/conf/env.sh
